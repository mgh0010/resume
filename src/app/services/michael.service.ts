...
export class MichaelService {
  skillsData = {
    'angular': {'name': 'Angular', 'id': 'angular'}, 'ngrx': {'name': 'NgRx', 'id': 'ngrx'},
    'javascript': {'name': 'Javascript', 'id': 'javascript'}, 'css': {'name': 'CSS', 'id': 'css'},
    'html': {'name': 'HTML', 'id': 'html'}, 'jquery': {'name': 'Jquery', 'id': 'html'},
